...
public class SentencePreprocessor {
	 ...
	 */
	List<List<String>> process(List<List<String>> document) {
	 ...
	 */
	private List<List<String>> removeStopwords(List<List<String>> document) {
		
		List<List<String>> processed = new ArrayList<>();

		for (List<String> oldSentence : document) {
			List<String> newSentence = new ArrayList<>();

			for (String anOldSentence : oldSentence) {
				if (!stopwords.contains(anOldSentence)) {
					newSentence.add(anOldSentence);
				}
			}
	 ...
	 */
	private List<List<String>> removePunctuation(List<List<String>> document) {
